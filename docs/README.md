...
|Twitter|[yosuke_takeuchi](https://twitter.com/yosuke_takeuchi)|
|Qiita|[yosuke_takeuchi](https://qiita.com/yosuke_takeuchi)|
|Zenn|[yosuke_takeuchi](https://zenn.dev/yosuke_takeuchi)|
...
- ※経験年数は経営層・マネジメント層・営業層へ向けて 1 つの判断材料として記入してます。エンジニアの皆さまは私の GitHub を見ていただき、どの程度の技術力なのかを判断していただくのが良いと思っております

### 言語

| 言語名      | スキルレベル   | 経験年数（Y は年数を示しています）| 備考                                                                                    |
|------------|--------------|--------------|-----------------------------------------------------------------------------------------|
...
| TypeScript |       A      |       2Y      | フロントで使用、最新の仕様も把握しています（バックエンドは個人でのみ）                               |
...
| 名前             | スキルレベル | 経験年数（Y は年数を示しています）| 備考|
|------------------|--------------|--------------|------|
...
| Vue.js          |       A      |       3Y     | フロントの開発で 1 番多く使っています。 基本的に Nuxt.js の中で触りますが Vuex も含めた SPA 開発も行ったことがあります。   |
| React           |       C      |       0.5Y   | 個人開発での使用経験のみ。Redux, hooks もある程度の理解はあります。       |
| Nuxt.js         |       A      |       3Y     | 複数の新規開発案件、グロース案件での使用経験あり。 |
...
| サービス名            | スキルレベル |経験年数（Y は年数を示しています）| 備考       |
|-----------------------|-------------|-----------|------------------|
